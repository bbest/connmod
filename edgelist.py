# Temporarily using networkx/trunk/networkx/readwrite/edgelist.py@1560
#  with networkx-1.0rc1-py2.5.egg
# for reading in edge weight dictionary
# until incorporated into networkx-1.1
